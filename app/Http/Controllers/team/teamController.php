...
class teamController extends Controller
{
    ...
    public function update_firm_background(Request $request)
    {
        ...
        if ($firmBackground->id) {
            ...
            $ComplianceWatch->team_user_id = Auth::guard('team')->id();
    ...
    public function update_compliance_watch(Request $request)
    {
        // dd($request->all());
    ...
    public function update_on_ground_verification(Request $request)
    {
        // dd($request->all());
    ...
    public function update_Business_Intelligence(Request $request)
    {
        // dd($request->all());
    ...
    public function update_Key_Observation(Request $request)
    {
    ...
    public function vender_List(Request $request)
    {

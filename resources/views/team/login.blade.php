...
<meta name="format-detection" content="telephone=no">
    <!-- PAGE TITLE HERE -->
    <title>ALTBUSINESSINTEL | Team Login </title>
    <!-- FAVICONS ICON -->
    ...
    <div class="col-xl-6 col-lg-6">
			<div class="pages-left h-100">
				<div class="login-content">
					...
					<p>Alternis Business Intelligence dashboard Team line charts to visualize.</p>
				</div>
		...
		<div class="col-lg-6 col-md-12 col-sm-12 mx-auto align-self-center">
			<div class="login-form">
				<div class="text-center">
					...
					<p>Sign in to your account to start using Alternis Business Intelligence Team  Dahsboard</p>

...
<script src="{{URL::to('/public/admin/assets')}}/vendor/chart.js/Chart.bundle.min.js"></script>
...
<script src="{{URL::to('/public/admin/assets')}}/js/plugins-init/chartjs-init.js"></script>

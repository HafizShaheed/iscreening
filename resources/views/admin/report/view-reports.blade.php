        ...
        <div class="card-body justify-content-center">
            <div class="d-flex flex-row flex-nowrap">
                ...
                <a href="JavaScript:void(0)" id="click-Tax-Return-and-Credit"
                    class="btn btn-secondary report-tab-unactive border-round-tab btn-sm mx-1 p-lg-3">
                    Credit</a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);" class="col-md-4 text-start">
                                                                        @if(!empty($Gst->{'gst_upload_file_'.$i}))
                                                                            <a href="{{ URL::to('/panel/report/gst_compliance_watch_download'.'/'.base64_encode($Gst->id).'/'.$i) }}" target="_blank" class="download-license-btn" style=" width: 100px;  text-align: center; ">Download </a>
                                                                        @else
                                                                            <!-- Handle if document doesn't exist -->
                                                                            <a  class="download-license-btn" style=" width: 200px;  text-align: center; ">N/A</a>
                                                                        @endif
                                                                    ...
                                                                    <td style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);" class="col-md-2 text-end">
                                                                        @if(!empty($Gst->{'gst_upload_file_'.$i}))
                                                                            <a href="{{ URL::to('/panel/report/gst_compliance_watch_view'.'/'.base64_encode($Gst->id).'/'.$i) }}" target="_blank" class="download-license-btn" style=" width: 200px;  text-align: center; ">View</a>
                                                                        @else
                                                                            <!-- Handle if document doesn't exist -->
                                                                            <a  class="download-license-btn" style=" width: 200px;  text-align: center; ">N/A</a>
                                                                        @endif
                                            ...
                                            <table class="table primary-table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="{{ URL::to('/panel/report/onGround_file_download'.'/'. base64_encode($OnGroundVerification->id)) }}" class="download-license-btn" style="display: inline-block; width: 200px;  text-align: center; ">Download Report</a>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);" class="col-md-2 text-start">
                                                                            @if(!empty($MarketReputation->{'offLine_upload_file_'.$i}))
                                                                                <a href="{{ URL::to('/panel/report/market_file_offline_download'.'/'.base64_encode($MarketReputation->id).'/'.$i) }}" target="_blank" class="download-license-btn" style=" width: 100px;  text-align: center; ">Download </a>
                                                                            @else
                                                                                <!-- Handle if document doesn't exist -->
                                                                                <a  class="download-license-btn" style=" width: 200px;  text-align: center; ">N/A</a>
                                                                            @endif
                                                                        ...
                                                                        <td style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);" class="col-md-2 text-end">
                                                                            @if(!empty($MarketReputation->{'offLine_upload_file_'.$i}))
                                                                                <a href="{{ URL::to('/panel/report/market_file_offline_view'.'/'.base64_encode($MarketReputation->id).'/'.$i) }}" target="_blank" class="download-license-btn" style=" width: 200px;  text-align: center; ">View</a>
                                                                            @else
                                                                                <!-- Handle if document doesn't exist -->
                                                                                <a  class="download-license-btn" style=" width: 200px;  text-align: center; ">N/A</a>
                                                                            @endif
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);" class="col-md-2 text-start">
                                                                            @if(!empty($MarketReputation->{'onLine_upload_file_'.$i}))
                                                                                <a href="{{ URL::to('/panel/report/market_file_online_download'.'/'.base64_encode($MarketReputation->id).'/'.$i) }}" target="_blank" class="download-license-btn" style=" width: 100px;  text-align: center; ">Download </a>
                                                                            @else
                                                                                <!-- Handle if document doesn't exist -->
                                                                                <a  class="download-license-btn" style=" width: 200px;  text-align: center; ">N/A</a>
                                                                            @endif
                                                                        ...
                                                                        <td style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);" class="col-md-2 text-end">
                                                                            @if(!empty($MarketReputation->{'onLine_upload_file_'.$i}))
                                                                                <a href="{{ URL::to('/panel/report/market_file_online_view'.'/'.base64_encode($MarketReputation->id).'/'.$i) }}" target="_blank" class="download-license-btn" style=" width: 200px;  text-align: center; ">View</a>
                                                                            @else
                                                                                <!-- Handle if document doesn't exist -->
                                                                                <a  class="download-license-btn" style=" width: 200px;  text-align: center; ">N/A</a>
                                                                            @endif

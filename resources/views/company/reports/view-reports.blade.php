                                    ...
                                    <div class="tab-pane fade show active" id="Key-Observation" role="tabpanel">
                                        <div class="pt-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 mb-3">
                                                    <p for="educationalBackground" class="text-center"><a href="{{ URL::to('/company/report/generate_pdf_of_reports'.'/'.base64_encode($getThirdPartyForID->id)) }}" class="download-license-btn">Download Licenses</a></p>
                                                </div>
